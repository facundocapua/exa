    ...
    return (
      <div className={containerClassName}>
        <div
          ...
          className={clsx(
            'relative flex items-center rounded-md text-sm shadow-2xs ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-primary-600 px-4 w-full h-11',
