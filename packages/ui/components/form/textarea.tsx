  ...
  (props, ref) => {
    ...
    return (
      <div className={clsx(
        ...
        <textarea
          className={clsx(
            'peer h-24 rounded-md shadow-sm ring-1 ring-gray-300 focus-within:ring-2 focus-within:ring-primary-600 px-4 border-t-[20px] border-transparent w-full text-sm',
