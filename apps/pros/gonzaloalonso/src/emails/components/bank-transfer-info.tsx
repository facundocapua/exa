export const BankTransferInfo = () => {
  return (
    <>
      ...
      <p>
        <span className="font-bold">Alias</span>: facu.exa.mp
      </p>
      <p>
        <span className="font-bold">CVU</span>: 0000003100019347000871
      </p>
      <p>
        <span className="font-bold">CUIT</span>: 20-25739618-6
      </p>
