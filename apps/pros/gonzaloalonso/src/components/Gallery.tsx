...
const imagesClasses = [
  'w-full block h-[350px] md:h-full md:min-h-[320px] rounded-xl md:row-span-2 relative',
  'w-full block h-[350px] md:h-full md:min-h-[320px] rounded-xl md:col-span-2 relative',
  'w-full block h-[350px] md:h-full md:min-h-[320px] rounded-xl relative',
  'w-full block h-[350px] md:h-full md:min-h-[320px] rounded-xl md:row-span-2 relative',
  'w-full block h-[350px] md:h-full md:min-h-[320px] rounded-xl relative',
  'w-full block h-[350px] md:h-full md:min-h-[320px] rounded-xl relative'
]
