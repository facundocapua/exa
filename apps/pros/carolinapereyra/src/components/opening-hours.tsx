  ...
  return (
    <section className='relative'>
      <div className='absolute w-full h-full -z-10 object-cover overflow-hidden'>
        <div className='from-primary-200 from-0 to-100% md:from-20% md:to-80% 2xl:from-30% 2xl:to-70% via-primary-500/20 to-primary-200 w-full h-full bg-linear-to-r absolute z-10'></div>
