      ...
      <div className="md:grid md:grid-cols-[60%_40%] items-center md:flex-row">
        <div className={clsx(
          ...
          <div className="relative z-10 lg:w-full lg:max-w-2xl">
            <div className="relative px-2 py-2 md:py-0 md:px-6">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-2xl">
                ...
                <Link href="/portfolio" className="md:mt-6 block text-primary-100 text-sm md:text-lg md:leading-8 md:text-gray-900">
