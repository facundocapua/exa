...
export default function NewOrderEmail () {
  return (
    <Html lang="es" dir="ltr">
      <Tailwind>
        <Section className='bg-[#EDEAE6] text-neutral-700 font-sans '>
          <Container className='my-4 p-4 max-w-[600px]'>
            ...
            <Section>
              <h2 className='text-neutral-900'>Número de pedido: {'{{ display_id }}'}</h2>
            </Section>
            <Section>
              <h3 className='text-neutral-600 font-semibold'>Resumen</h3>
              {'{{#each items}}'}
              <Row className='mb-4 border-b border-neutral-500'>
                ...
                <Column className='w-3/5 align-top'>
                  ...
                  <Text className='text-neutral-500 m-0'>{'{{ this.variant.title }}'}</Text>
                </Column>
                <Column className='text-right align-top'>
                  <Text className='text-xs text-neutral-500'>{'{{ this.price }}'} x {'{{ this.quantity }}'}</Text>
                </Column>
              </Row>
              {'{{/each}}'}
              <Hr />
            ...
            <Section>
              <h3 className='text-neutral-600 font-semibold'>Envío</h3>
              <Row>
                <Column className='w-1/2 align-top'>
                  <Text className='text-neutral-600 font-semibold text-base'>Dirección de envío</Text>
            ...
            <Hr className='border-neutral-500' />
            <Section>
              <h3 className='text-neutral-600 font-semibold'>Pago</h3>
              <Row>
                <Column className='w-1/2 align-top'>
                  <Text className='text-neutral-600 font-semibold text-base'>Dirección de facturación</Text>
            ...
            <Section className='text-center my-12'>
              <Button className='bg-neutral-800 text-white px-4 py-2 rounded-md' href={'https://carolinapereyra.exapro.com.ar/order/confirmed/{{ id }}'}>Ver pedido</Button>
            </Section>
            <Footer />
          </Container>
        </Section>
